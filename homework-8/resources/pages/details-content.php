...
<div class="movie-info">
	<div class="movie-info__head">
		<div class="movie-info__head__name">
			<div class="movie-info__head__name__title"><?= htmlspecialchars(formatMovieTitle($movie['TITLE'],
					$movie['RELEASE_DATE'])) ?></div>
			<div class="movie-info__head__name__bottom">
				<div class="movie-info__head__name__bottom__subtitle"><?= htmlspecialchars($movie['ORIGINAL_TITLE']) ?></div>
				<div class="movie-info__head__name__bottom__age-restriction"><?= htmlspecialchars($movie['AGE_RESTRICTION'])
					. '+' ?></div>
			</div>
		</div>
		...
		<div class="movie-info__body__details">
			...
			<ul class="movie-info__body__details__about-list">
				<li class="movie-info__body__details__about-list__item">
					...
					<div class="movie-info__body__details__about-list__item__value"><?= htmlspecialchars($movie['RELEASE_DATE']) ?></div>
				</li>
				<li class="movie-info__body__details__about-list__item">
					<div class="movie-info__body__details__about-list__item__key">Режиссер:</div>
					<div class="movie-info__body__details__about-list__item__value"><?= htmlspecialchars($movie['DIRECTOR']) ?></div>
				</li>
				<li class="movie-info__body__details__about-list__item">
					<div class="movie-info__body__details__about-list__item__key">В главных ролях:</div>
					<div
						class="movie-info__body__details__about-list__item__value"><?= htmlspecialchars(formatActorsArray($movie['ACTORS'])) ?> </div>
				</li>
			</ul>
			<div class="movie-info__body__details__heading">Описание</div>
			<div class="movie-info__body__details__description"><?= htmlspecialchars($movie['DESCRIPTION']) ?></div>
		</div>
	</div>
</div>